...
if __name__ == "__main__":
    ...
    data_dir = r"E:\AIL\project\Bert-TextClassification\Data\origin"
    output_dir = ".Result/" 
    cache_dir = ".Cache/"
    log_dir = ".Logs/" 
    train_val_rate='8:2'
    ...
    # bert-base
    bert_vocab_file = r"E:\AIL\project\Bert-TextClassification\Bert_weight\bert-base-uncased-vocab.txt"
    bert_model_dir = r"E:\AIL\project\Bert-TextClassification\Bert_weight\bert-base-uncased.tar.gz"

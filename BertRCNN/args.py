...
def get_args(data_dir, output_dir, cache_dir, bert_vocab_file, bert_model_dir, log_dir, max_seq_length):
    ...
    # TextRNN 参数
    parser.add_argument("--hidden_size", default=100, type=int, help="隐层特征维度")
